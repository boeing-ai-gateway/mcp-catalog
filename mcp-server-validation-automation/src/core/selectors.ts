const Selectors = {
    ...
    boeingPopUp: '//dialog[contains(@class, "fixed top-1/2 left-1/2")]',
    ...
    createnewboeingButton: "//button[contains(@class, 'button') and contains(., 'Create New Agent')]",
    ...
    boeingUpdatedname: '//h4[@class="mb-1!"]',
    ...
    confirmDeleteBoeingButton: '//h3[text()="Delete the current Boeing?"]/following-sibling::button[contains(text(), "Yes") and contains(@class, "bg-red-600")]',
    ...
    chatIntroductionInBoeing: '//div[contains(@class,"message-content")]',
    chatStarterMsgInBoeing: '//button/span[@class="line-clamp-3"]',
    ...
    editBoeingName:'//span[text()="Name & Description "]',
    ...
    modelApi:'//input[@id="BOEING_OPENAI_MODEL_PROVIDER_API_KEY"]',
    ...
    MCP:{
        ...
        clickChatBoeing: '//button[normalize-space(text())="Chat"]',
        ...
        boeingInput: "//div[contains(@class,'ProseMirror') and @contenteditable='true']",
        ...
        popupContinueButton: '//h2[text()="Welcome to Boeing!"]/following::button[text()="Continue"]',
        wordpressMCP:{
      ...
      //p[contains(@class,"font-light")]`,
        ...
        adminNavigation: {
            ...
            welcomeToBoeingTitle: '//h2[text()="Welcome to Boeing!"]',
        },
    }
}
